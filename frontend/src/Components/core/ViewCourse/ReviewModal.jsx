            ...
            <div className="z-50 my-10 w-11/12 max-w-[700px] rounded-lg border border-richblack-400 bg-richblack-800 fixed left-[50%] top-[50%] -translate-x-1/2 -translate-y-1/2">
                ...
                <div className="p-5">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="mt-6 flex flex-col items-center">
                        ...
                        <input
                            value={getValues().userRating} {...register("userRating", { required: true })} type="hidden"
                        />
                        ...
                        <div className="flex w-11/12 flex-col space-y-2">
                            ...
                            <textarea {...register("userExperience", { required: true })} className='form-style resize-x-none min-h-[130px] w-full' placeholder='Write your experience...'/>
                            {errors.userExperience && <span className='text-pink-200 text-[12px]'>* Please provide your expirence</span>}
                        </div>

                        <div className="mt-6 flex w-11/12 justify-end gap-x-2">
                            <button onClick={()=>{setReviewModal(false)}} className="px-4 py-2 rounded-lg text-sm font-medium bg-richblack-300">
                                Cancel
                            </button>
                            <button type="submit" className="px-4 py-2 rounded-lg text-sm font-medium text-black  bg-yellow-100">
                                Submit
                            </button>
                        </div>
                    </form>
