...

                {
                    tabsName.map((element, index) => {
                        return(
                            ...
                            : "text-richblack-200 "} rounded-full transition-all duration-200 cursor-pointer hover:bg-richblack-900 hover:text-richblack-5 px-3 py-1 lg:py-2 text-center`}
                            key = {index}
