            ...
            <div className="mx-auto mt-20 flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-white lg:flex-row">
                <div className="lg:w-[40%]">
                    ...
                    <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                        ...
                        <p className="font-semibold">team.studynotion@gmail.com</p>
                    </div>
                    <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                        <div className="flex flex-row items-center gap-3">
                        ...
                        <p className="font-semibold">Charusat Collage , Changa , Nadiad-Petlad Highway</p>
                    </div>
                    <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                        <div className="flex flex-row items-center gap-3">
                        ...
                        <p className="font-semibold">+91 9099129982</p>
                    </div>    
                    </div>
                </div>
